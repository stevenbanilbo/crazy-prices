           ...
           alt="About Coffee"/>
                <div className="md:h-full rounded overflow-hidden bg-gray-200 p-1 rounded-tr-md justify-around shadow-lg">
                  ...
                  <div class="px-6 pt-4 pb-2">
                    <span class="inline-block bg-blue-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#coffee</span>
                    <span class="inline-block bg-blue-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#coffeebeans</span>
